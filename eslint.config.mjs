...
export default tseslint.config(
  // Configuración para todos los archivos TypeScript
  {
    files: ["**/*.ts", "**/*.tsx"],
    ignores: [
  ...
  // Configuración específica para los archivos de Flowstark
  {
    files: ["**/flowstark/**/*.{ts,tsx}"],
    rules: {
      // Deshabilita estas reglas solo para tus archivos de Flowstark
